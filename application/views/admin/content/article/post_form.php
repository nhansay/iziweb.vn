    ...
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h2 class="panel-title"><i class="fa fa-plus"></i> Thêm mới bài viết</h2>
            </div>
            <div class="panel-body">
                <?= form_open('admin/post/add_new', array('id'=>'main-form', 'class'=>'form-horizontal')); ?>
